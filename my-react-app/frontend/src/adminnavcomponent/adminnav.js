      ...
      <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div className="collapse navbar-collapse" id="navbarCollapse">
          <div className="navbar-nav ms-auto py-0">
            <Link to="/admin/index" className="nav-item nav-link active">Home</Link>
            <Link to="/admin/manageuser" className="nav-item nav-link">Manage Users</Link>
            <Link to="/admin/setting" className="nav-item nav-link">Settings</Link>
